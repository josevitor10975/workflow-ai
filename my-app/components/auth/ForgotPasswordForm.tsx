...
export function ForgotPasswordForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!MOCK_EXISTING_EMAILS.includes(normalizedEmail)) {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className={`h-11 rounded-md bg-background px-3 text-base text-foreground placeholder:text-muted-foreground focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-0 ${error ? "border-destructive focus-visible:ring-destructive" : "border-input"}`}
              />
              {error && (
                <p
                  id="email-error"
