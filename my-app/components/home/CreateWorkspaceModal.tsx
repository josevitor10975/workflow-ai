              ...
              {workspaceIcons.map(({ id, label, icon }) => {
                ...
                return (
                  <button
                    ...
                    className={`flex size-12 items-center justify-center rounded-lg border transition-none ${isSelected ? "border-foreground bg-muted text-foreground" : "text-muted-foreground"}`}
                  >
