...
import { ArrowRight, Code2, FileCode2, Folder, Image, MoreHorizontal, Plus, Trophy } from "lucide-react";
...
const recentWorkspaces = [
  { name: "SaaS Landing Page", lastBattle: "2 days ago", battles: 3, artifacts: 12, icon: Folder },
  { name: "API Architecture", lastBattle: "4 days ago", battles: 2, artifacts: 8, icon: Code2 },
  { name: "E-commerce Dashboard", lastBattle: "1 week ago", battles: 4, artifacts: 16, icon: Image },
  { name: "Mobile App UI", lastBattle: "1 week ago", battles: 2, artifacts: 7, icon: FileCode2 },
];
