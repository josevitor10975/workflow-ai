...
const recentWorkspaces = [
  { id: "1", name: "SaaS Landing Page", lastBattle: "2 days ago", battles: 3, artifacts: 12, icon: Folder },
  { id: "2", name: "API Architecture", lastBattle: "4 days ago", battles: 2, artifacts: 8, icon: Code2 },
  { id: "3", name: "E-commerce Dashboard", lastBattle: "1 week ago", battles: 4, artifacts: 16, icon: Image },
  { id: "4", name: "Mobile App UI", lastBattle: "1 week ago", battles: 2, artifacts: 7, icon: FileCode2 },
];
        ...
        <div className="mx-auto w-full max-w-7xl">
          ...
          <section className="mt-20 md:mt-24">
            <div className="mb-5 flex items-center justify-between gap-4">
              ...
              <Button variant="ghost" size="sm" nativeButton={false} render={<Link href="/workspaces" />} className="text-sm text-muted-foreground">View all<ArrowRight /></Button>
            </div>
                    ...
                    <Card className="h-full">
                      <CardContent className="flex h-full min-h-44 flex-col p-5">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <span aria-hidden="true" className="flex size-8 items-center justify-center text-muted-foreground"><MoreHorizontal className="size-4" /></span>
                        </div>
                        <div className="mt-4">
